...
<div class="content-box-large">
	<div class="row">
		<div class="panel-heading">
			<div class="panel-title ">Liên hệ với người dùng</div>
		</div>
	</div>
	...
	<div class="row">
		<div class="panel-body">
			<form action="${pageContext.request.contextPath }/admin/contact/recycle/del"  method="post">
				...
				<tbody>
					<c:forEach items="${listContact }" var="contact">
						<tr class="odd gradeX">
							...
							<td><a href="${pageContext.request.contextPath }/admin/contact/recycle/active/${contact.cid}" title="" class="btn btn-primary">
